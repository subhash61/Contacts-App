...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"details.js":[function(require,module,exports) {
"use strict";
...
var details = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              location.assign("/".concat(res.data.data.user.slug, "/contactInfo"));
            }
  ...
  return function details(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.details = details;
},{"axios":"../../node_modules/axios/index.js"}],"sendMessage.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // eslint-disable-next-line no-restricted-globals
              location.assign("/".concat(res.data.data.user.slug, "/contactInfo/sendMessage"));
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'OTP sent successfully');
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Error sending OTP. PLease try again.');
            window.setTimeout(function () {
              location.assign('/');
            }, 1200);
...
var moreDetailsBtn = document.querySelectorAll('.more__details');
var sendMessageBtn = document.querySelector('.contact__send--btn');
var conactListBtn = document.querySelector('.sidebar__btn--1');
var messageSentBtn = document.querySelector('.sidebar__btn--2');
var contactListBloc = document.querySelector('.overview__content--messages');
var messageSentBloc = document.querySelector('.overview__content--block');
var sendTextBtn = document.querySelector('.send__text');

if (moreDetailsBtn) {
  moreDetailsBtn.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      var userId = e.target.dataset.userId;
      (0, _details.details)(userId);
    });
  });
}
...
if (sendMessageBtn) {
  sendMessageBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var userId = e.target.dataset.userId;
    (0, _sendMessage.sendMessage)(userId);
  });
}

if (conactListBtn) {
  conactListBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (messageSentBtn) {
  messageSentBtn.addEventListener('click', function (e) {
    e.preventDefault();
    contactListBloc.classList.add('hidden');
    messageSentBloc.classList.add('hidden');
